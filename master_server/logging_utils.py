...
def setup_master_logging(log_dir: str, level: str = "INFO", retention_days: int = 14) -> str:
    ...
    logging.getLogger(__name__).info("master 日志系统已启用，目录=%s，保留天数=%s", log_dir, retention_days)
    return log_dir
